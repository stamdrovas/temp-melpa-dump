;;; boon-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(register-definition-prefixes "boon-core" '("boon" "isearch-exit" "swiper--action"))
...
Jump to the end of the current expression." t)
(autoload 'boon-beginning-of-expression "boon-moves" "\
Jump to the beginning of the current expression." t)
...
Move point leftwards to the first visible beginning of line." t)
...
If mark active, switch point and mark, otherwise pop mark from mark ring." t)
(autoload 'boon-switch-mark-quick "boon-moves" "\
Pop the mark ring until we find ourselves on a different line." t)
(make-obsolete 'boon-switch-mark-quick '"annoying" "20160901")
...
(register-definition-prefixes "boon-utils" '("boon-"))

;;; End of scraped data

(provide 'boon-autoloads)
